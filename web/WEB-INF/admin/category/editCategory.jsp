...
<head>
    ...
    <title>Periodicals - <fmt:message key="admin" bundle="${bundle}"/> - <fmt:message key="editCategory"
                                                                                      bundle="${bundle}"/></title>
...
<div class="container">
    ...
    <div class="col-md-8">
        ...
        <form class="form-horizontal" method="post"
              action="${pageContext.request.contextPath}/admin/categories/update?id=${category.id}">
            <fieldset>

                <legend><fmt:message key="editCategory" bundle="${bundle}"/></legend>

                <div class="form-group">
                    <label class="col-md-3 control-label" for="name"><fmt:message key="title"
                                                                                  bundle="${bundle}"/></label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <a class='btn btn-danger'
                           href="${pageContext.request.contextPath}/admin/categories/delete?id=${category.id}">
