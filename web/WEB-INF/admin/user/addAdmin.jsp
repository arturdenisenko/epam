...
<head>
    ...
    <title>Periodicals- <fmt:message key="admin" bundle="${bundle}"/> - <fmt:message key="addAdmin"
                                                                                     bundle="${bundle}"/></title>
        ...
        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/admin/admins/add">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="fname"><fmt:message key="firstName"
                                                                                   bundle="${bundle}"/></label>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="lname"><fmt:message key="lastName"
                                                                                   bundle="${bundle}"/></label>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="email"><fmt:message key="email"
                                                                                   bundle="${bundle}"/></label>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="password"><fmt:message key="password"
                                                                                      bundle="${bundle}"/></label>
                    <div class="col-md-4">
