...
<head>
    ...
    <title>Periodicals - <fmt:message key="admin" bundle="${bundle}"/> - <fmt:message key="admins"
                                                                                      bundle="${bundle}"/></title>
...
<div class="container">
    ...
    <div class="col-md-10">
        ...
        <ul class="nav nav-tabs nav-justified">
            <li role="presentation"><a href="${pageContext.request.contextPath}/admin/users?p=1&s=10"><fmt:message
                    key="users" bundle="${bundle}"/></a></li>
            <li role="presentation" class="active"><a href="#"><fmt:message key="admins" bundle="${bundle}"/></a></li>
        </ul>
        ...
        <div class="row">
            <ul class="pager">
                <c:if test="${!page.first}">
                    <li>
                        <a href="${pageContext.request.contextPath}/admin/admins?p=${page.number-1}&s=${page.size}">
